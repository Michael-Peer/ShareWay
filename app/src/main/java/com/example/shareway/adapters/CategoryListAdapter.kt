...
import com.example.shareway.utils.extensions.vibrate
...
//            LayoutInflater.from(parent.context).inflate(R.layout.category_list_item, parent, false)
    ...
    override fun onBindViewHolder(holder: CategoryListViewHolder, position: Int) {
        ...
        if (!isEditMode) {
            holder.itemView.dragIcon.setOnTouchListener { v, event ->
                context.vibrate(80)
...
//        submitList(listRef)
    ...
    /**
     *
     * We assign the context here for several reasons.
     *
     * We get the context only once, when we attach the recyclerView.
     * Unnecessary to pass vis constructor
     *
     *  If the adapter adapter lingers outside our Activity lifespan  we  already have a leak.
     *
     *
     * **/
